...
if(_type == "recon_safe")then

{

_veh animate ["door", 1];
_veh animate ["door2", 1];
_veh animate ["door3", 1];
_veh animate ["door4", 1];
_veh animate ["door5", 1];
_veh animate ["door6", 1];
_veh animate ["door7", 1];
_veh animate ["door8", 1];
_veh animate ["door9", 1];
_veh animate ["door10", 1];
_veh animate ["door11", 1];
...
buttonSetAction [3,   format['if ((lbCurSel 1) >= 0) then {["nehmen",  "%1", ctrlText 2, (lbData [1, (lbCurSel 1)]),"%3", %2] execVM "3550568.sqf"; closedialog 0; [0,0,0,["%1", "%3", %2]] execVM "1098936.sqf";};', _arrname, _extra, _public] ];
buttonSetAction [103, format['if ((lbCurSel 101) >= 0) then {["ablegen", "%1", ctrlText 102, (lbData [101, (lbCurSel 101)]), "%3", %2] execVM "3550568.sqf"; closedialog 0; [0,0,0,["%1", "%3", %2]] execVM "1098936.sqf";};', _arrname, _extra, _public] ];
...
_veh animate ["door", 0];
_veh animate ["door2", 0];
_veh animate ["door3", 0];
_veh animate ["door4", 0];
_veh animate ["door5", 0];
_veh animate ["door6", 0];
_veh animate ["door7", 0];
_veh animate ["door8", 0];
_veh animate ["door9", 0];
_veh animate ["door10", 0];
_veh animate ["door11", 0];
