...
["RHIB",["Fahrzeug", "boat"],["RHIB", "RHIB"], [25000, 15000],[0, "", "", 200], [100,[1,2,0,10] ], "RHIB" call ISSE_Cfg_Vehicle_GetName, "RHIB" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 8],["ebauteile", 4],["glas", 8],["plastik", 20],["erdoel", 5],["kupfer", 20],["schwarzpulver", 15]] ],
...
["MMT_Civ",["Fahrzeug", "car"],["smurfcbike", "Bicycle"],[250, 200],[1, "", "", 20], [150, [1,0,0,3]], "smurfcbike" call ISSE_Cfg_Vehicle_GetName, "smurfcbike" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 1]] ],
["MMT_USMC",["Fahrzeug", "car"],["smurfcbike", "Bicycle"],[250, 200],[1, "", "", 20], [150, [1,0,0,3]], "smurfcbike" call ISSE_Cfg_Vehicle_GetName, "smurfcbike" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 1]] ],

////////////////////////////////////////////////////////////Cars/////////////////////////////////////////////////////////////////////

["Skoda",["Fahrzeug", "car"],["Skoda", "Skoda"],[7500, 7000], [1, "car", "probator", 100], [150, [1,0,0,3]], "Skoda" call ISSE_Cfg_Vehicle_GetName, "Skoda" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 4],["glas", 1],["plastik", 1],["erdoel", 4]] ],
["SkodaBlue",["Fahrzeug", "car"],["SkodaBlue", "Blue Skoda"],[7500, 7000], [1, "car", "probator", 100], [150, [1,0,0,3]], "SkodaBlue" call ISSE_Cfg_Vehicle_GetName, "SkodaBlue" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 4],["glas", 1],["plastik", 1],["erdoel", 4]] ],
["SkodaRed",["Fahrzeug", "car"],["SkodaRed", "Red Skoda"],[7500, 7000], [1, "car", "probator", 100], [150, [1,0,0,3]], "SkodaRed" call ISSE_Cfg_Vehicle_GetName, "SkodaRed" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 4],["glas", 1],["plastik", 1],["erdoel", 4]] ],
["SkodaGreen",["Fahrzeug", "car"],["SkodaGreen", "Green Skoda"],[7500, 7000], [1, "car", "probator", 100], [150, [1,0,0,3]], "SkodaGreen" call ISSE_Cfg_Vehicle_GetName, "SkodaGreen" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 4],["glas", 1],["plastik", 1],["erdoel", 4]] ],
["civic",["Fahrzeug", "car"],["civic", "1989 Honda Civic"],[7500, 7000], [1, "car", "probator", 100], [150, [1,0,0,3]], "civic" call ISSE_Cfg_Vehicle_GetName, "civic" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 4],["glas", 1],["plastik", 1],["erdoel", 4]] ],
["UAZ_CDF", ["Fahrzeug", "car"],["UAZ_CDF", "UAZ"],[14000, 12000], [2, "car", "", 120], [350,[1,0,0,6] ], "slr_landroverPolice" call ISSE_Cfg_Vehicle_GetName, "slr_landroverPolice" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 10],["ebauteile", 1],["glas", 2],["plastik", 2],["mineraloel", 5]]],
["LadaLM",["Fahrzeug", "car"],["LadaLM", "Lada (VAZ)"],[10500, 9500], [1, "car", "", 120], [150, [1,0,0,3]], "slr_policeSkoda" call ISSE_Cfg_Vehicle_GetName, "slr_policeSkoda" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 10],["ebauteile", 1],["mineraloel", 5]] ],
["Lada_base",["Fahrzeug", "car"],["Lada_base", "VAZ"],[10500, 9500], [1, "car", "probator", 120], [150, [1,0,0,3]], "Lada_base" call ISSE_Cfg_Vehicle_GetName, "Lada_base" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 4],["glas", 1],["plastik", 1],["erdoel", 4]] ],
["Lada1",["Fahrzeug", "car"],["Lada1", "VAZ (White)"],[10500, 9500], [1, "car", "probator", 120], [150, [1,0,0,3]], "Lada1" call ISSE_Cfg_Vehicle_GetName, "Lada1" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 4],["glas", 1],["plastik", 1],["erdoel", 4]] ],
["Lada2",["Fahrzeug", "car"],["Lada2", "VAZ (Red)"],[10500, 9500], [1, "car", "probator", 120], [150, [1,0,0,3]], "Lada2" call ISSE_Cfg_Vehicle_GetName, "Lada2" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 4],["glas", 1],["plastik", 1],["erdoel", 4]] ],
["VWGolf",["Fahrzeug", "car"],["VWGolf", "Volkswagen Golf"],[21000, 19250], [1, "car", "", 150], [150, [1,0,0,3]], "Car_hatchback" call ISSE_Cfg_Vehicle_GetName, "Car_hatchback" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 5],["ebauteile", 1],["glas", 1],["plastik", 1],["erdoel", 5]] ],
...
["Civcar",["Fahrzeug", "car"],["Civcar", "Holden Monaro(Orange)"],[50000, 47250], [1, "car", "", 180], [150, [1,0,0,3]], "Civcar" call ISSE_Cfg_Vehicle_GetName, "Civcar" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 5],["ebauteile", 1],["glas", 1],["plastik", 1],["erdoel", 5]] ],
["Civcarbl",["Fahrzeug", "car"],["Civcarbl", "Holden Monaro(Black)"],[50000, 47250], [1, "car", "", 180], [150, [1,0,0,3]], "Civcarbl" call ISSE_Cfg_Vehicle_GetName, "Civcarbl" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 5],["ebauteile", 1],["glas", 1],["plastik", 1],["erdoel", 5]] ],
["Civcarbu",["Fahrzeug", "car"],["Civcarbu", "Holden Monaro(Blue)"],[50000, 47250], [1, "car", "", 180], [150, [1,0,0,3]], "Civcarbu" call ISSE_Cfg_Vehicle_GetName, "Civcarbu" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 5],["ebauteile", 1],["glas", 1],["plastik", 1],["erdoel", 5]] ],
["Civcarge",["Fahrzeug", "car"],["Civcarge", "Holden Monaro(Green)"],[50000, 47250], [1, "car", "", 180], [150, [1,0,0,3]], "Civcarge" call ISSE_Cfg_Vehicle_GetName, "Civcarge" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 5],["ebauteile", 1],["glas", 1],["plastik", 1],["erdoel", 5]] ],
["Civcarre",["Fahrzeug", "car"],["Civcarre", "Holden Monaro(Red)"],[50000, 47250], [1, "car", "", 180], [150, [1,0,0,3]], "Civcarre" call ISSE_Cfg_Vehicle_GetName, "Civcarre" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 5],["ebauteile", 1],["glas", 1],["plastik", 1],["erdoel", 5]] ],
["Civcarsl",["Fahrzeug", "car"],["Civcarsl", "Holden Monaro(Silver)"],[50000, 47250], [1, "car", "", 180], [150, [1,0,0,3]], "Civcarsl" call ISSE_Cfg_Vehicle_GetName, "Civcarsl" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 5],["ebauteile", 1],["glas", 1],["plastik", 1],["erdoel", 5]] ],
["Civcarwh",["Fahrzeug", "car"],["Civcarwh", "Holden Monaro(White)"],[50000, 47250], [1, "car", "", 180], [150, [1,0,0,3]], "Civcarwh" call ISSE_Cfg_Vehicle_GetName, "Civcarwh" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 5],["ebauteile", 1],["glas", 1],["plastik", 1],["erdoel", 5]] ],
["car_hatchback",["Fahrzeug", "car"],["Car_hatchback", "Hatchback"],[9500, 8250], [1, "car", "probator", 130], [150, [1,0,0,3]], "Car_hatchback" call ISSE_Cfg_Vehicle_GetName, "Car_hatchback" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 5],["ebauteile", 1],["glas", 1],["plastik", 1],["erdoel", 5]] ],
["Car_Sedan",["Fahrzeug", "car"],["Car_Sedan", "Sedan"],[9500, 8250], [1, "car", "probator", 130], [150, [1,0,0,3]], "Car_Sedan" call ISSE_Cfg_Vehicle_GetName, "Car_Sedan" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 5],["ebauteile", 1],["glas", 1],["plastik", 1],["erdoel", 5]] ],
...
["oltruc3",["Fahrzeug", "car"],["oltruc3", "F-250 Pickup"],[18000, 16000], [1, "car", "probator", 200], [150, [1,0,0,3]], "Skoda" call ISSE_Cfg_Vehicle_GetName, "Skoda" call ISSE_Cfg_Vehicle_GetDesc, [["steel", 4],["glass", 1],["plastic", 1],["plastic", 4]] ],

///////////////////////////////////////////////////////////Sports Cars//////////////////////////////////////////////////////////////////////

["rosco",["Fahrzeug", "car"],["rosco", "Plymouth Fury"],[55000, 51500], [1, "", "probator", 100], [150, [1,0,0,3]], "Skoda" call ISSE_Cfg_Vehicle_GetName, "Skoda" call ISSE_Cfg_Vehicle_GetDesc, [["steel", 4],["glass", 1],["plastic", 1],["plastic", 4]] ],
...
["roadrunner2",["Fahrzeug", "car"],["roadrunner2", "69 Road Runner"],[175000, 171500], [1, "car", "probator", 100], [150, [1,0,0,3]], "Skoda" call ISSE_Cfg_Vehicle_GetName, "Skoda" call ISSE_Cfg_Vehicle_GetDesc, [["steel", 4],["glass", 1],["plastic", 1],["plastic", 4]] ],
["challenger",["Fahrzeug", "car"],["challenger", "08 Dodge Challenger"],[130000, 128250], [1, "car", "probator", 180], [150, [1,0,0,3]], "challenger" call ISSE_Cfg_Vehicle_GetName, "challenger" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 5],["ebauteile", 1],["glas", 1],["plastik", 1],["erdoel", 5]] ],
["cd71hm",["Fahrzeug", "car"],["cd71hm", "Plymouth Hemicuda"],[135000, 131500], [1, "car", "probator", 100], [150, [1,0,0,3]], "Skoda" call ISSE_Cfg_Vehicle_GetName, "Skoda" call ISSE_Cfg_Vehicle_GetDesc, [["steel", 4],["glass", 1],["plastic", 1],["plastic", 4]] ],
["monaco",["Fahrzeug", "car"],["monaco", "68 Dodge Monaco"],[130000, 127000], [1, "car", "probator", 100], [150, [1,0,0,3]], "Skoda" call ISSE_Cfg_Vehicle_GetName, "Skoda" call ISSE_Cfg_Vehicle_GetDesc, [["steel", 4],["glass", 1],["plastic", 1],["plastic", 4]] ],
...
["oldtruc2a",["Fahrzeug", "car"],["oldtruc2a", "Vintage Farm Truck, Carrier"],[18000, 15000], [1, "truck", "probator", 350], [100, [1,0,0,0]], "oldtruc2a" call ISSE_Cfg_Vehicle_GetName, "oldtruc2a" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 4],["glas", 1],["plastik", 1],["erdoel", 4]] ],
["oldtruc2",["Fahrzeug", "car"],["oldtruc2", "Vintage Farm Truck"],[18000, 15000], [1, "truck", "probator", 350], [100, [1,0,0,0]], "oldtruc2" call ISSE_Cfg_Vehicle_GetName, "oldtruc2" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 4],["glas", 1],["plastik", 1],["erdoel", 4]] ],
...
["hilux1_civil_1_open", ["Fahrzeug", "car"],["hilux1_civil_1_open", "Offroad (Tan)"],[25000, 22750], [2, "car", "patrol_training", 250], [350,[1,0,0,1] ], "hilux1_civil_1_open" call ISSE_Cfg_Vehicle_GetName, "hilux1_civil_1_open" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 10],["ebauteile", 1],["glas", 2],["plastik", 2],["erdoel", 5]]],
["hilux1_civil_2_covered",["Fahrzeug", "car"],["hilux1_civil_2_covered", "Offroad (Red)"],[25000, 22750], [2, "car", "patrol_training", 250], [350,[1,0,0,1]], "hilux1_civil_2_covered" call ISSE_Cfg_Vehicle_GetName, "hilux1_civil_2_covered" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 10],["ebauteile", 1],["glas", 2],["plastik", 2],["erdoel", 5]] ], 
["hilux1_civil_3_open", ["Fahrzeug", "car"],["hilux1_civil_3_open", "Police Offroad"], [25000, 22750], [2, "car", "response_training", 250], [350, [1,0,0,1] ], "hilux1_civil_3_open" call ISSE_Cfg_Vehicle_GetName, "hilux1_civil_3_open" call ISSE_Cfg_Vehicle_GetDesc, [["stahl", 10],["ebauteile", 1],["glas", 2],["plastik", 2],["erdoel", 5]]],
...
["SUV_TK_CIV_EP1",["Fahrzeug", "car"],["SUV_TK_CIV_EP1", "Suburban"],[35000, 32500], [2, "car", "patrol_training", 200], [150, [1,0,0,3]], "Skoda" call ISSE_Cfg_Vehicle_GetName, "Skoda" call ISSE_Cfg_Vehicle_GetDesc, [["steel", 4],["glass", 1],["plastic", 1],["plastic", 4]] ],
["LandRover_TK_CIV_EP1",["Fahrzeug", "car"],["LandRover_TK_CIV_EP1", "LandRover"],[65000, 63000], [2, "car", "probator", 200], [150, [1,0,0,3]], "Skoda" call ISSE_Cfg_Vehicle_GetName, "Skoda" call ISSE_Cfg_Vehicle_GetDesc, [["steel", 4],["glass", 1],["plastic", 1],["plastic", 4]] ],
["LandRover_CZ_EP1",["Fahrzeug", "car"],["LandRover_CZ_EP1", "LandRover Desert"],[70000, 63000], [2, "car", "probator", 200], [150, [1,0,0,3]], "Skoda" call ISSE_Cfg_Vehicle_GetName, "Skoda" call ISSE_Cfg_Vehicle_GetDesc, [["steel", 4],["glass", 1],["plastic", 1],["plastic", 4]] ],
